...
@Component({
  selector: 'app-func-perfil',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './func-perfil.component.html',
  styleUrl: './func-perfil.component.scss'
})
export class FuncPerfilComponent {
  ...
  get initials(): string { return (this.profileForm.username ?? 'F').slice(0, 2).toUpperCase(); }
